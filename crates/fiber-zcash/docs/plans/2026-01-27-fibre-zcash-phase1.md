# Fibre-Zcash Phase 1: Compact Block Protocol Implementation Plan
...
```bash
cd /Users/zakimanian/fiber-zcash
cargo init --lib
```
...
repository = "https://github.com/zmanian/fiber-zcash"
...
```rust
//! Fiber-Zcash: Low-latency block relay network for Zcash
//!
...
chore: initialize fiber-zcash project
